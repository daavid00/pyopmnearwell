...
.. grid:: 1 1 2 2
   ...
   .. grid-item::
      ...
      .. button-link:: https://github.com/cssr-tools/pyopmnearwell/blob/main/examples/co2.toml
         :color: primary
         :outline:
         :expand:
   ...
   .. grid-item::
      ...
      .. button-link:: https://raw.githubusercontent.com/cssr-tools/pyopmnearwell/main/examples/co2.toml
         :color: primary
         :outline:
         :expand:
