...
% if control == 0:
[${tperiod},${tperiod},1,${-1*qrate},3.6e1,"0.01 0.1 1e-12"],
% elif control == 1:
[${tperiod},${tperiod},1,${0*qrate},"0.01 0.1 1e-12"],
% else:
[${tperiod},${tperiod},1,${qrate},"0.01 0.1 1e-12"],
% endif
% endfor
[730,730,1,${-200000. / 6},3.6e1,"0.01 10 1e-12"]]