...
def pyopmnearwell_error(message: str) -> NoReturn:
    ...
    raise SystemExit(f"{pyopmnearwell_name()}: {label}: {message}")


def pyopmnearwell_warning(message: str) -> None:
    ...
    print(f"{pyopmnearwell_name()}: {label}: {message}", file=sys.stderr)


def pyopmnearwell_info(message: str) -> None:
    ...
    print(f"{pyopmnearwell_name()}: {label}: {message}")


def pyopmnearwell_tip(message: str) -> None:
    ...
    print(f"{pyopmnearwell_name(sys.stdout)}: {label}: {message}")


def pyopmnearwell_success(msg: str, output_dir: str, filenames: list[str]) -> None:
    ...
    if not filenames:
        print(f"{pyopmnearwell_name()}: {label}: {msg}{output_dir}")
    elif len(filenames) == 1:
        print(f"{pyopmnearwell_name()}: {label}: {msg}{output_dir}/{filenames[0]}")
    elif len(filenames) <= 5:
        print(f"{pyopmnearwell_name()}: {label}{msg}")
...
def pyopmnearwell_name(stream: object = sys.stderr) -> str:
